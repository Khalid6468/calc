...
public class StandardCalculatorTest {
    ...
    void testMultiplicationOperationForDoubles() {
        standardCalculator.multiply(1.5, 3.6);
        double actualResult = standardCalculator.getResult();
        Assertions.assertEquals(5.4, actualResult);
    }

    @Test
    @DisplayName("Test Division of Two Doubles")
    void testDivisionOperationForDoubles() {
        standardCalculator.divide(9, 1.5);
        double actualResult = standardCalculator.getResult();
    ...
    void testDivisionOperation() {
        standardCalculator.divide(3, 2);
        double actualResult = (int)standardCalculator.getResult();
